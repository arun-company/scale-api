...
urlpatterns = [
    ...
    url(r'^user/(?P<account_id>[0-9a-f-]*)/image$',views.FileUploadView.as_view()),
    url(r'^auth/login/', views.CustomAuthToken.as_view()),
    url(r'^auth/password-request/', views.ResetPassword.as_view()),
